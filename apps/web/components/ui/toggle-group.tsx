      ...
      className={cn(
        ...
        variant === "default"
          ...
          : orientation === "horizontal"
            ...
            : "*:not-first:before:-top-[0.5px] *:not-last:before:-bottom-[0.5px] *:not-first:rounded-t-none *:not-last:rounded-b-none *:not-first:border-t-0 *:not-last:border-b-0 *:not-last:before:hidden *:not-first:before:rounded-t-none *:not-last:before:rounded-b-none flex-col dark:*:first:before:block dark:*:last:before:hidden",
        className
      )}
      data-size={size}
